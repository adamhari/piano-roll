...
var FileInputControl_1 = require("./FileInputControl");
var InputRecorderControl_1 = require("./InputRecorderControl");
var DigitalControl_1 = require("./DigitalControl");
var KnobControl_1 = require("./KnobControl");
var Waveform_1 = require("./Waveform");
var statics_1 = require("../js/statics");
var Instrument = function (props) {
    var activeControl = props.activeControl, handleClickControl = props.handleClickControl, handleMouseDownControl = props.handleMouseDownControl, handleMouseUpControl = props.handleMouseUpControl, handleMouseWheelControl = props.handleMouseWheelControl, recording = props.recording, sampleLoading = props.sampleLoading, sampleLoaded = props.sampleLoaded, layout = props.layout, volume = props.volume, polyphony = props.polyphony, portamento = props.portamento, attack = props.attack, decay = props.decay, sustain = props.sustain, release = props.release, mode = props.mode, sample = props.sample, samplePitch = props.samplePitch, osc1Shape = props.osc1Shape, osc1Octave = props.osc1Octave, osc1Transpose = props.osc1Transpose, osc1Detune = props.osc1Detune, osc1Gain = props.osc1Gain, osc2Shape = props.osc2Shape, osc2Octave = props.osc2Octave, osc2Transpose = props.osc2Transpose, osc2Detune = props.osc2Detune, osc2Gain = props.osc2Gain, modOscShape = props.modOscShape, modOscFreq = props.modOscFreq, modOscGain = props.modOscGain, filter1Type = props.filter1Type, filter1Rolloff = props.filter1Rolloff, filter1Freq = props.filter1Freq, filter1Q = props.filter1Q, filter2Type = props.filter2Type, filter2Rolloff = props.filter2Rolloff, filter2Freq = props.filter2Freq, filter2Q = props.filter2Q, vibratoDepth = props.vibratoDepth, vibratoFreq = props.vibratoFreq, vibratoWet = props.vibratoWet, chorusSpread = props.chorusSpread, chorusDepth = props.chorusDepth, chorusDelay = props.chorusDelay, chorusWet = props.chorusWet, crusherBits = props.crusherBits, crusherWet = props.crusherWet, distOver = props.distOver, distAmount = props.distAmount, distWet = props.distWet, pitcherPitch = props.pitcherPitch, pitcherWindow = props.pitcherWindow, pitcherWet = props.pitcherWet, reverbSize = props.reverbSize, reverbDampening = props.reverbDampening, reverbWet = props.reverbWet;
    var sharedControlProps = {
        ...
        handleMouseWheelControl: handleMouseWheelControl,
    };
    var renderGlobalSection = function () { return (<div id="global-section">
			{renderLogo()}
			{renderGlobalControls()}
		</div>); };
    var renderLogo = function () { return (<div id="logo-section">
			<svg id="logo" viewBox="304.103 332.216 470.661 104.256">
				<g>
					<path d="M 654.248 361.208 L 652.04 368.792 L 623.528 431 L 608.264 431 L 635.24 373.784 L 617.768 373.784 L 621.512 361.208 L 654.248 361.208 Z " fill="rgb(171,171,171)"/>
					...
					<path d=" M 403.136 361.208 L 382.592 431 L 368.192 431 L 376.832 401.528 L 369.536 401.528 L 360.8 431 L 346.4 431 L 366.944 361.208 L 381.344 361.208 L 373.184 389.144 L 380.48 389.144 L 388.736 361.208 L 403.136 361.208 Z " fill="rgb(171,171,171)"/>
					...
					<path d=" M 509.216 431 L 529.76 361.208 L 542.144 361.208 L 542.624 388.184 L 550.592 361.208 L 564.608 361.208 L 544.064 431 L 532.448 431 L 531.2 403.16 L 522.848 431 L 509.216 431 Z " fill="rgb(171,171,171)"/>
    ...
    var renderLeftControls = function () { return (<div id="instr-top-left">
			<DigitalControl_1.default {...sharedControlProps} name="polyphony" label="poly" control={statics_1.CONTROLS.polyphony} value={polyphony}/>
			<br />
			
			<DigitalControl_1.default {...sharedControlProps} name="layout" control={statics_1.CONTROLS.layout} value={layout} outline={true}/>
		</div>); };
    var renderGlobalControls = function () { return (<div id="global-controls">
			{renderVolumeControl()}
			{renderEnvelopeControls()}
		</div>); };
    var renderVolumeControl = function () { return (<div>
			<KnobControl_1.default {...sharedControlProps} name="volume" value={volume} size="large"/>
		</div>); };
    var renderEnvelopeControls = function () { return (<div id="envelope-controls">
			<div>
				<KnobControl_1.default {...sharedControlProps} name="attack" value={attack} size="small"/>
			</div>
			<div>
				<KnobControl_1.default {...sharedControlProps} name="decay" value={decay} size="small"/>
			</div>
			<div>
				<KnobControl_1.default {...sharedControlProps} name="sustain" value={sustain} size="small"/>
			</div>
			<div>
				<KnobControl_1.default {...sharedControlProps} name="release" value={release} size="small"/>
			</div>
		</div>); };
    var renderModeSelector = function () { return (<div id="mode-selector" className="control-section">
			<div className="control-wrapper vertical">
				<div className="controls-container-label">MODE</div>
				<div className="controls-container">
					<ButtonControl_1.default {...sharedControlProps} name="mode" value="sampler" active={mode === 'sampler'} size="large"/>
					<ButtonControl_1.default {...sharedControlProps} name="mode" value="synth" active={mode === 'synth'} size="large"/>
				</div>
			</div>
		</div>); };
    var renderSampler = function () {
        return mode === statics_1.MODES.SAMPLER && (<div id="sampler" className="control-section">
				<div className="control-wrapper vertical">
					<div className="controls-container-label">SAMPLER</div>
					<div className="controls-container">
						<div style={{ display: 'flex' }}>
							<FileInputControl_1.default {...sharedControlProps} name="sample" label="load" value={'load'} blinking={sampleLoading} active={sampleLoaded} type="file" accept={statics_1.SUPPORTED_SAMPLE_FORMATS.join(', ')} size="small"/>
							<InputRecorderControl_1.default {...sharedControlProps} label="record" active={recording} size="small"/>
							
						</div>
						<Waveform_1.default {...sharedControlProps} audio={sample} label={'waveform'}/>
						<KnobControl_1.default {...sharedControlProps} name="samplePitch" label="pitch" value={samplePitch} size="small"/>
					</div>
				</div>
			</div>);
    };
    var renderSynth = function () {
        return mode === statics_1.MODES.SYNTH && (<>
				{renderOscillators()}
				{renderModOscillator()}
			</>);
    };
    var renderOscillators = function () { return (<div id="oscillators" className="control-section">
			<div className="control-wrapper horizontal">
				<div className="controls-container-label">OSC 1</div>
				<div className="controls-container">
					<DigitalControl_1.default {...sharedControlProps} name="osc1Shape" label="shape" value={osc1Shape}/>
					<DigitalControl_1.default {...sharedControlProps} name="osc1Octave" label="octave" value={osc1Octave}/>
					<DigitalControl_1.default {...sharedControlProps} name="osc1Transpose" label="trans" value={osc1Transpose}/>
					<KnobControl_1.default {...sharedControlProps} name="osc1Detune" label="tune" value={osc1Detune} size="medium"/>
					<KnobControl_1.default {...sharedControlProps} name="osc1Gain" label="vol" value={osc1Gain} size="medium"/>
				</div>
			</div>
			<div className="control-wrapper horizontal">
				<div className="controls-container-label">OSC 2</div>
				<div className="controls-container">
					<DigitalControl_1.default {...sharedControlProps} name="osc2Shape" label="shape" value={osc2Shape} type="single-digit"/>
					<DigitalControl_1.default {...sharedControlProps} name="osc2Octave" label="octave" value={osc2Octave}/>
					<DigitalControl_1.default {...sharedControlProps} name="osc2Transpose" label="trans" value={osc2Transpose}/>
					<KnobControl_1.default {...sharedControlProps} name="osc2Detune" label="tune" value={osc2Detune} size="medium"/>
					<KnobControl_1.default {...sharedControlProps} name="osc2Gain" label="vol" value={osc2Gain} size="medium"/>
				</div>
			</div>
		</div>); };
    var renderModOscillator = function () { return (<div id="mod-oscillator" className="control-section">
			<div className="control-wrapper vertical">
				<div className="controls-container-label">MOD OSC</div>
				<div className="controls-container">
					<DigitalControl_1.default {...sharedControlProps} name="modOscShape" label="shape" value={modOscShape} type="single-digit"/>
					<KnobControl_1.default {...sharedControlProps} name="modOscFreq" label="freq" value={modOscFreq} size="small"/>
					<KnobControl_1.default {...sharedControlProps} name="modOscGain" label="vol" value={modOscGain} size="small"/>
				</div>
			</div>
		</div>); };
    var renderFilters = function () { return (<div id="filters" className="control-section">
			<div className="control-wrapper horizontal">
				<div className="controls-container-label">FILTER 1</div>
				<div className="controls-container">
					<DigitalControl_1.default {...sharedControlProps} name="filter1Type" label="type" value={filter1Type}/>
					<DigitalControl_1.default {...sharedControlProps} name="filter1Rolloff" label="steep" value={filter1Rolloff}/>
					<KnobControl_1.default {...sharedControlProps} name="filter1Freq" label="cutoff" value={filter1Freq} size="medium"/>
					<KnobControl_1.default {...sharedControlProps} name="filter1Q" label="res" value={filter1Q} size="medium"/>
				</div>
			</div>
			<div className="control-wrapper horizontal">
				<div className="controls-container-label">FILTER 2</div>
				<div className="controls-container">
					<DigitalControl_1.default {...sharedControlProps} name="filter2Type" label="type" value={filter2Type}/>
					<DigitalControl_1.default {...sharedControlProps} name="filter2Rolloff" label="steep" value={filter2Rolloff}/>
					<KnobControl_1.default {...sharedControlProps} name="filter2Freq" label="cutoff" value={filter2Freq} size="medium"/>
					<KnobControl_1.default {...sharedControlProps} name="filter2Q" label="res" value={filter2Q} size="medium"/>
				</div>
			</div>
		</div>); };
    var renderVibrato = function () { return (<div id="vibrato" className="control-section">
			<div className="control-wrapper vertical">
				<div className="controls-container-label">VIBRATO</div>
				<div className="controls-container">
					<KnobControl_1.default {...sharedControlProps} name="vibratoDepth" label="depth" value={vibratoDepth} size="small"/>
					<KnobControl_1.default {...sharedControlProps} name="vibratoFreq" label="freq" value={vibratoFreq} size="small"/>
					<KnobControl_1.default {...sharedControlProps} name="vibratoWet" label="wet" value={vibratoWet} size="small"/>
				</div>
			</div>
		</div>); };
    var renderChorus = function () { return (<div id="chorus" className="control-section">
			<div className="control-wrapper vertical">
				<div className="controls-container-label">CHORUS</div>
				<div className="controls-container">
					<KnobControl_1.default {...sharedControlProps} name="chorusSpread" label="spread" value={chorusSpread} size="small"/>
					<KnobControl_1.default {...sharedControlProps} name="chorusDepth" label="depth" value={chorusDepth} size="small"/>
					
					<KnobControl_1.default {...sharedControlProps} name="chorusWet" label="wet" value={chorusWet} size="small"/>
				</div>
			</div>
		</div>); };
    var renderBitcrusher = function () { return (<div id="distortion" className="control-section">
			<div className="control-wrapper vertical">
				<div className="controls-container-label">BITCRUSHER</div>
				<div className="controls-container">
					<DigitalControl_1.default {...sharedControlProps} name="crusherBits" label="bits" value={crusherBits}/>
					<KnobControl_1.default {...sharedControlProps} name="crusherWet" label="wet" value={crusherWet} size="small"/>
				</div>
			</div>
		</div>); };
    var renderDistortion = function () { return (<div id="distortion" className="control-section">
			<div className="control-wrapper vertical">
				<div className="controls-container-label">DISTORTION</div>
				<div className="controls-container">
					
					<KnobControl_1.default {...sharedControlProps} name="distAmount" label="amount" value={distAmount} size="small"/>
					<KnobControl_1.default {...sharedControlProps} name="distWet" label="wet" value={distWet} size="small"/>
				</div>
			</div>
		</div>); };
    var renderPitcher = function () { return (<div id="pitcher" className="control-section">
			<div className="control-wrapper vertical">
				<div className="controls-container-label">PITCHER</div>
				<div className="controls-container">
					<KnobControl_1.default {...sharedControlProps} name="pitcherPitch" label="pitch" value={pitcherPitch} size="small"/>
					<KnobControl_1.default {...sharedControlProps} name="pitcherWindow" label="slice" value={pitcherWindow} size="small"/>
					<KnobControl_1.default {...sharedControlProps} name="pitcherWet" label="wet" value={pitcherWet} size="small"/>
				</div>
			</div>
		</div>); };
    var renderReverb = function () { return (<div id="reverb" className="control-section">
			<div className="control-wrapper vertical">
				<div className="controls-container-label">REVERB</div>
				<div className="controls-container">
					<KnobControl_1.default {...sharedControlProps} name="reverbSize" label="size" value={reverbSize} size="small"/>
					<KnobControl_1.default {...sharedControlProps} name="reverbDampening" label="damp" value={reverbDampening} size="small"/>
					<KnobControl_1.default {...sharedControlProps} name="reverbWet" label="wet" value={reverbWet} size="small"/>
				</div>
			</div>
		</div>); };
    var renderPianoKeys = function () { return <PianoKeys_1.default {...props}/>; };
    return (<div id="instr">
