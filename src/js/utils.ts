...
export const getNoteFromValues = (
  freq: number,
  octave: number,
  transpose: number,
) => {
...
// (0 - 100) --> (-Infinity - 0)
export const getDecibelsFromValue = (value: number) =>
...
// (0 - 100) --> (0.0001 - 4)
export const getSecondsFromValue = (value: number) =>
  Math.pow(value, 2) / 2500 || 0.0001;

// (0 - 100) --> (0.03125 - 32)
export const getHarmonicityFromValue = (value: number) =>
  Math.pow(2, (value - 50) / 10);
